      ...
      <div className="space-y-5">
        {polls.map((poll) => {
          ...
          return (
            <div
              key={poll.id}
              className="rounded-3xl border border-[#eadfd4] bg-white p-6 shadow-sm md:p-8"
            >
              <div className="flex flex-col justify-between gap-5 md:flex-row">
                ...
                <button
                  ...
                  className="h-fit rounded-xl border border-[#C1622B] px-4 py-2 text-sm font-semibold text-[#C1622B] transition hover:bg-[#f8e8dc]"
                >
                  View Results
                </button>
              </div>
        ...
        >
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                onClick={() => setIsCreateModalOpen(false)}
                className="flex h-9 w-9 items-center justify-center rounded-full bg-[#f8e8dc] text-gray-600 hover:bg-[#C1622B] hover:text-white"
              >
                ×
              </button>
            </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-[#eadfd4] px-4 py-3 text-sm outline-none focus:border-[#C1622B]"
                  >
        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                onClick={() => setSelectedPoll(null)}
                className="text-xl text-gray-500 hover:text-[#C1622B]"
              >
                ×
              </button>
            </div>
            ...
            <div className="mt-6 rounded-2xl bg-[#faf6f0] p-4 text-sm text-gray-600">
              Total votes cast:{" "}
            ...
            {selectedPoll.status === "Active" && (
              <button
                ...
                className="mt-6 w-full rounded-xl border border-red-200 px-4 py-3 font-semibold text-red-600 hover:bg-red-50"
              >
                Close Poll
              </button>
            )}
